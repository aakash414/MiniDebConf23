      ...
      className='flex flex-col'>
        <div className='mt-[15vh] grid grid-cols-1 md:grid-cols-2'>
          ...
          <div className='md:mt-40 mt-20'>
            <h1 className='text-[#a80030] text-center m-auto text-5xl md:text-8xl font-[900] ubuntu'>MiniDebConf</h1>
            <div className='flex justify-center'>
              <h1 className='text-[#a80030] text-center text-3xl md:text-6xl mr-10 md:mr-40 font-[900] ubuntu'>Kochi'23</h1>
              <h1 className='text-[#a80030] text-center text-3xl md:text-6xl ubuntu'>CUSAT</h1>
            </div>
          </div>
        </div>
        <a
